function doQuery(obj){
	...
	function view_standard_form(instanceId,url){
		if(url==""||typeof (url)=="undefined"){//查看自定义表单
			...
			var childWin = window.open(url,'childWin',"top=0,left=0,toolbar=no,location=no,directories=no,status=yes,menubar=no,scrollbars=yes,resizable=yes,width="+screen.availWidth+",height="+screen.availHeight);
		}else{
			var win = window.open(webRoot+"/engine/monitor-view.htm?instanceId="+instanceId+"&operationName=view",'win',"top=0,left=0,toolbar=no,location=no,directories=no,status=yes,menubar=no,scrollbars=false,resizable=no,width="+screen.availWidth+",height="+screen.availHeight);
		}
	}
			...
			$.ajax({
				   ...
				   success: function(systemUrl){
					if(systemUrl==""||typeof(systemUrl)=='undefined'){
						...
						var childWin = window.open(url,'',"top=0,left=0,toolbar=no,location=no,directories=no,status=yes,menubar=no,scrollbars=false,resizable=no,width="+screen.availWidth+",height="+screen.availHeight);
					}
	...
	function urgen_done(){
		...
		if(ids==''){
			...
			if(url==""||typeof (url)=="undefined"){
				...
				var win = window.open(webRoot+"/engine/monitor-view.htm?instanceId="+ids[0]+"&operationName=urgenDone",'win',"top=0,left=0,toolbar=no,location=no,directories=no,status=yes,menubar=no,scrollbars=false,resizable=no,width="+screen.availWidth+",height="+screen.availHeight);
			}
		}
	}
