						...
						<table style="width: 550px;">  
						   <tr style="width: 550px;">
						  	...
						  	<td id="dataMap" align="left" style="width: 100px;">
								...
								<td style="width: 108px;">—单行文本控件id：</td><td style="width: 80px;"><input type="text" name="itemTitle" id="itemTitle"></td> <td style="width: 100px;"><input type="checkbox" name="isQuery" id="isQuery" title="是否作为查询字段"><label for="isQuery">查</label>
