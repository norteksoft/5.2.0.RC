		...
		_fn : {
			...
			change_state : function (obj, state) {
				...
				if(state) { 
					...
					//liudongxia--修改(当多选树时，选中了节点，展开树节点)
				 	this.open_node(obj,function(){}, false);
				...
				obj.parentsUntil(".jstree", "li").each(function () {
					...
					if(_tree_type=='DEPARTMENT_TREE'||_tree_type=='GROUP_TREE'||_tree_type=='DEPARTMENT_WORKGROUP_TREE'){
						if(state) {//去除勾选
